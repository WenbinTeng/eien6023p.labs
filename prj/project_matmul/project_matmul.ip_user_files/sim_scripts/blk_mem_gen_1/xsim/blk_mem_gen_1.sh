...
#
# Script generated by Vivado on Wed Dec 06 09:25:40 +0800 2023
...
# script info
echo -e "blk_mem_gen_1.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_mem_gen_1 xil_defaultlib.blk_mem_gen_1 xil_defaultlib.glbl -log elaborate.log
}
